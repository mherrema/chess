...
public class ChessPieceTest {
   ...
   // Doing so saves us the trouble of having to explicitly create them in (almost) every test.
   ...
   // Here, we create ChessPiece; but, subclasses will override this  method to create
   ...
   // method to generate a valid move.  When testing the parent ChessPiece class,
   ...
   @Test
   public void playerIsCorrect() throws Throwable {
   ...
   @Test
   public void complainsIfStartingAndEndingLocationsAreIdentical() throws Throwable {
      board[4][4] = piece;
      assertFalse("Move onto same loc", piece.isValidMove(new Move(4, 4, 4, 4), board));
   }
